...
def setup_product():
    ...
    import crgis.atcontents
    zcml.load_config('configure.zcml', crgis.atcontents)
    ...
    ztc.installPackage('crgis.atcontents')
...
setup_product()
ptc.setupPloneSite(products=['crgis.atcontents'])
