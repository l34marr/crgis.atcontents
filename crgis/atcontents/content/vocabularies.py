...
class deity_name(object):
    ...
    def __call__(self, context=None):
        items = (
            ...
            SimpleTerm(value='deity_002', title=_(u'deity_002', default=u'ChenHuang')),
            ...
            SimpleTerm(value='deity_006', title=_(u'deity_006', default=u'SanTaiTz')),
            SimpleTerm(value='deity_007', title=_(u'deity_007', default=u'BaoSengDaDi')),
            SimpleTerm(value='deity_008', title=_(u'deity_008', default=u'XuanTienDaDi')),
            SimpleTerm(value='deity_009', title=_(u'deity_009', default=u'WuGuDaDi')),
            ...
            SimpleTerm(value='deity_013', title=_(u'deity_013', default=u'YuHuangDaDi')),
            SimpleTerm(value='deity_014', title=_(u'deity_014', default=u'WangMuNN')),
            SimpleTerm(value='deity_015', title=_(u'deity_015', default=u'SanGuanDaDi')),
