...
PloneQuickUpload.onUploadComplete = function(uploader, domelement, id, fileName, responseJSON) {
    ...
    if (responseJSON.success) {  
        if (responseJSON.file_name) {
            var uploadedFiles = uploadList.data('uploaded-files');
            if (uploadedFiles) {
                uploadList.data('uploaded-files', uploadedFiles + '|' + responseJSON.file_name);
            } else {
                uploadList.data('uploaded-files', responseJSON.file_name);
            }
        }
